...
```js
document.createDocumentFragment(); // узел-пустышка, используется для миграции включенных в него узлов в основное DOM дерево (применяется для оптимизации производительности);
